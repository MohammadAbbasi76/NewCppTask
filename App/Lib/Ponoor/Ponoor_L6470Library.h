...
public:
  ...
  void SPIPortConnect(ConcreteSPI *SPIPort);
...
#define SW_USER                                                                \
  0x0010 // Tie to the GoUntil and ReleaseSW
...
#define EXT_16MHZ_OSCOUT_INVERT                                                \
  0x000D // External 16MHz crystal, output inverted
#define EXT_24MHZ_OSCOUT_INVERT                                                \
  0x000E // External 24MHz crystal, output inverted
#define EXT_32MHZ_OSCOUT_INVERT                                                \
  0x000F // External 32MHz crystal, output inverted
#endif
