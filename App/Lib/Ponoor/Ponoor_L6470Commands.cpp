...
//  the dSPIN chip.
int32_t AutoDriver::getParam(uint8_t param)
{
...
void AutoDriver::goTo(int32_t pos)
{
  SPIXfer(CMD_GOTO);
...
void AutoDriver::goToDir(uint8_t dir, int32_t pos)
{
...
//  ABS_POS values.
void AutoDriver::setMark(int32_t newMark)
{
  setParam(MARK, newMark);
}

void AutoDriver::setPos(int32_t newPos)
{
